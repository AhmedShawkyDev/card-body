  ...
  return (
    <div>
      ...
      >
        <label
          htmlFor="option1"
          className={` xl:ml-[-5] lg:ml-5 h-[263px] cursor-pointer text-black hover:text-[#CEA768] border-2 border-[#C8C8CA] p-3 rounded-xl hover:border-[#CEA768]
        ...
        >
          ...
          />
          <img
            className=" w-[326px] h-[208px] bg-cover rounded-xl xl:mt-[-35px] lg:mt-[-18px] md:mt-[-17px] sm:mt-[-16px]"
            src={img1}
            alt=""
          />
          <h1
