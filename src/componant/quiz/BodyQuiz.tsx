  ...
  return (
    <div>
      <div className="bg-neutral-300 h-[8px] md:w-[534px] w-[200px] mt-6 rounded-b-xl  rounded-t-xl mx-auto my-auto">
        <div className="bg-[#CEA768] h-[8px] md:w-[106px] w-1/5 mt-6 rounded-b-xl  rounded-t-xl"></div>
      </div>
      ...
      >
        ...
        <label
          htmlFor="option2"
          className={`xl:mr-[-5] lg:mr-5 md:h-[263px] h-[200px] cursor-pointer text-black hover:text-[#CEA768] border-2 border-[#C8C8CA] md:p-3 p-1 rounded-xl hover:border-[#CEA768]
      ...
      <div className=" my-6 lg:m-5 xl:mt-9 md:my-5  sm:my-5 font-semibold flex justify-center items-center mt-13">
        <button
          onClick={two}
