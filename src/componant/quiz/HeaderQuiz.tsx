...
//         <div
//           className="
//           xl:w-[1062px] xl:h-[626px] xl:text-[24px]
//           flex-col justify-between rounded-3xl bg-white text-white
...
//                 cursor-pointer hover:text-[#CEA768]
//                  hover:bg-white hover:rounded-full hover:duration-100

//                  "
//               >
//                 <FaArrowLeft
//                   className="
//                 xl:mr-3 xl:mt-1 xl:ml-2
//                 lg:mr-3 lg:mt-1 lg:ml-7
//                 md:mr-3 md:mt-1 md:ml-7
//                 sm:mr-3 sm:mt-1 sm:ml-5
//                 "
//                 />
...
const Header: React.FC<HeaderProps> = ({ isClose }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center modal position-relative opacity-100">
      <div className="xl:w-[1062px] xl:h-[626px] flex-col justify-between rounded-3xl bg-white text-white">
        <div className="xl:w-full xl:h-[83px] bg-[#CEA768] flex justify-center items-center rounded-tr-3xl rounded-tl-3xl">
          <div className="xl:flex xl:justify-between xl:w-[982px] xl:h-[35px]">
            <button
              onClick={back}
              className="flex justify-center items-center cursor-pointer hover:text-[#CEA768] hover:bg-white hover:rounded-full hover:duration-100"
            >
              <FaArrowLeft className="xl:mr-3 xl:mt-1 xl:ml-2" />
              <div className="mt-0 font-normal text-[24px]">Back</div>
            </button>
            <h1 className="font-semibold mr-11 text-[24px]">
              Speak to Our Experts
