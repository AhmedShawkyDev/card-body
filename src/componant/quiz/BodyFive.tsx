  ...
  return (
    <div>
      <div className="bg-neutral-300 h-[8px] md:w-[534px] w-[200px] mt-6 rounded-b-xl  rounded-t-xl mx-auto my-auto">
        <div className="bg-[#CEA768] h-[8px] md:w-[106px] w-5/5 mt-6 rounded-b-xl  rounded-t-xl"></div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-7 ">
        ...
        >
          <h1 className="text-[11px] md:text-[13px] font-[Raleway] mt-2">
            Full Name
          </h1>
          <input
            value={input.name}
            ...
            className="border-1 border-[#C8C8CA] p-2 
             ...
             md:w-[600px] md:h-[40px] 
             lg:w-[718px] lg:h-[51px] 
             rounded-lg font-normal font-[Raleway] text-[13px]"
        ...
        <div
          className="flex flex-col text-black  
        justify-center items-center
        lg:justify-start lg:items-start  md:justify-center md:items-center  sm:justify-center sm:items-center"
        >
          <h1 className="text-[13px] font-[Raleway]">Phone Number</h1>
          <PhoneInput
            className=" border-2 border-[#C8C8CA] p-2
            w-[200px] h-[30px]
            sm:w-[400px] sm:h-[40px]
             md:w-[600px] md:h-[40px]
              lg:w-[718px] lg:h-[51px]
