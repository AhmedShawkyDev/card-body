...
const BodyFive: React.FC<BodyFiveProps> = ({ input, setInput, isClose }) => {
  ...
  return (
    <div>
      ...
      <h1 className="text-[#6B665F] sm:text-[16px]  md:text-[18px]  text-center text-wrap text-lg font-[Raleway] flex justify-center items-center mt-2 text-[18px]">
        We need your info to connect you with our experts and provide tailored
        recommendations.
      </h1>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-col  text-black lg:justify-start lg:items-start  md:justify-center md:items-center sm:justify-center sm:items-center ">
          <h1 className="text-[13px] font-[Raleway] mt-2">Full Name</h1>
          <input
            value={input.name}
            onChange={nameInput}
            type="text"
            className="border-1 border-[#C8C8CA] p-2 sm:w-[400px] sm:h-[40px] md:w-[600px] md:h-[40px] lg:w-[718px] lg:h-[51px] rounded-lg font-normal font-[Raleway] text-[16px]"
        ...
        <div className="flex flex-col text-black  lg:justify-start lg:items-start  md:justify-center md:items-center  sm:justify-center sm:items-center">
          ...
          <PhoneInput
            className=" border-2 border-[#C8C8CA] p-2  sm:w-[400px] sm:h-[40px] md:w-[600px] md:h-[40px] lg:w-[718px] lg:h-[51px] rounded-lg font-normal font-[Raleway] text-[16px] "
