...
//       sm:text-[20px]
//       md:text-[24px]
//       text-black flex justify-center items-center font-normal font-[Raleway] mt-2 text-[24px]"
//       >
...
//        sm:text-[16px]
//         md:text-[18px]
//       text-center text-[#6B665F] text-lg font-[Raleway] flex justify-center items-center mt-2 text-[18px]"
//       >
...
//                  border-2 border-[#C8C8CA] p-3 rounded-xl
//                   hover:border-[#CEA768] cursor-pointer ${
        ...
        {["option1", "option2", "option3", "option4"].map((option, index) => (
          <label
            ...
            className={`flex justify-start items-center w-[349px] h-[54px] text-black hover:text-[#CEA768] border-2 border-[#C8C8CA] p-3 rounded-xl hover:border-[#CEA768] cursor-pointer ${
              input.step4 === option ? " border-[#CEA768]" : ""
            }`}
          >
            <input
            ...
            <h1
              className={`flex justify-center font-[Roboto] mt-1 font-light items-center text-[18px] ${
                input.step4 === option ? "text-[#A37130]" : ""
              }`}
            >
              {index === 0
                ? "Less than 500k"
