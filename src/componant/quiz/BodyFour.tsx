  ...
  return (
    <div>
      <div className="bg-neutral-300 h-[8px] md:w-[534px] w-[200px] mt-6 rounded-b-xl  rounded-t-xl mx-auto my-auto">
        <div className="bg-[#CEA768] h-[8px] md:w-[106px] w-4/5 mt-6 rounded-b-xl  rounded-t-xl"></div>
      </div>
      ...
      <div className=" lg:m-5 xl:mt-30 md:my-5 sm:my-5 mt-16 font-semibold flex justify-center items-center">
        <button
          onClick={five}
